      ...
      <main>
        ...
        <section className="border-b border-border bg-white py-14 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <RevealOnScroll>
              <div className="space-y-10 text-[15px] leading-relaxed text-secondary sm:text-base">
                <p>
                ...
                <section aria-labelledby="privacy-interp-heading">
                  <h2
                    id="privacy-interp-heading"
                    className="text-xl font-medium tracking-tight text-charcoal sm:text-2xl"
                  >
                  ...
                  <ul className="mt-4 list-disc space-y-3 pl-5">
                    ...
                    <li>
                      ...
                      Agreement) refers to Premium Insurance Brokers 3063 Dougall
                      Ave. Windsor, Ontario N9E 1S7.
                    </li>
                    <li>
                      <strong className="font-medium text-charcoal">
                        Cookies
                    ...
                    <li>
                      ...
                      refers to Premium Insurance Brokers, accessible from
                      premiumib.com
                    </li>
                    <li>
                      <strong className="font-medium text-charcoal">You</strong>{" "}
                ...
                <section aria-labelledby="privacy-collect-heading">
                  ...
                  <h4 className="mt-5 text-base font-medium text-charcoal">
                    Personal Data
                  </h4>
                  <p className="mt-3">
                ...
                <section aria-labelledby="privacy-use-heading">
                  ...
                  <ul className="mt-3 list-disc space-y-2.5 pl-5">
                    ...
                    <li>
                      ...
                      is not shared with third parties or affiliates for marketing
                      purposes.
                    </li>
                  </ul>
                  <p className="mt-4">
                ...
                <section aria-labelledby="privacy-retention-heading">
                  <h2
                ...
                <section aria-labelledby="privacy-transfer-heading">
                  <h2
                    id="privacy-transfer-heading"
                    className="text-xl font-medium tracking-tight text-charcoal sm:text-2xl"
                  >
                ...
                <section aria-labelledby="privacy-disclosure-heading">
                  <h2
                ...
                <section aria-labelledby="privacy-security-heading">
                  <h2
                ...
                <section aria-labelledby="privacy-children-heading">
                  <h2
                  ...
                  <p className="mt-4">
                    ...
                    13 without verification of parental consent, We take steps to
                ...
                <section aria-labelledby="privacy-links-heading">
                  <h2
                    id="privacy-links-heading"
                    className="text-xl font-medium tracking-tight text-charcoal sm:text-2xl"
                  >
                ...
                <section aria-labelledby="privacy-changes-heading">
                  <h2
                ...
                <section aria-labelledby="privacy-sms-heading">
                  <h2
                    id="privacy-sms-heading"
                    className="text-xl font-medium tracking-tight text-charcoal sm:text-2xl"
                  >
                  ...
                  <p className="mt-4">
                    ...
                    agreeing to receive SMS messages from Premium Insurance
                    Brokers. This includes SMS messages for appointment
                    scheduling, appointment reminders, post-visit instructions,
                    notifications, and billing notifications. Message frequency
                    varies. Message and data rates may apply. Message HELP for
                ...
                <section aria-labelledby="privacy-contact-heading">
                  ...
                  <p className="mt-6">
                    ...
                    page for broker compensation disclosure.
                  </p>
                </section>
              </div>
            </RevealOnScroll>
