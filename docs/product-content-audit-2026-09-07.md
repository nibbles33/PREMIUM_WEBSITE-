...
|----------------|------:|---------|
| **A — STRONG** | 1 | Genuinely substantive, specific, no high/medium content-safety concerns |
| **B — ADEQUATE** | 8 | Reasonable depth; could be deepened; no high/medium safety flags |
| **C — THIN** | 16 | Noticeably shallow — similar pre-fix Greenhouse/Daycare pattern |
| **D — CONTENT-SAFETY** | 33 | High/medium content-safety language flagged (regardless of visual depth) |

**Total pages audited:** 58 live product routes.

**Key finding:** Only **Greenhouse & Agribusiness** (`/greenhouse-agribusiness-insurance/`) currently meets the STRONG bar established by the owner-approved fix. A large share of pages (33 D + 16 C = 49 pages, **84%**) combine thin or templated copy with unhedged "Covers…" / "Protects…" coverage-card language — the exact pattern Greenhouse was rewritten to avoid.
...
|-------|------------------:|--------------------------|--------------------------|----------:|-------------|-------------------------|----------------------|-------|
| /auto-insurance/ | 461 | 6 / specific (good) | No | 5 | No — Shares 2+ FAQ pattern with professional-offices-insurance | 5 | Ontario-wide | **D** |
...
| /condo-insurance/ | 547 | 4 / specific/hedged (strong) | Yes (83w, moderate) | 4 | Yes | 2 | Windsor-Essex-primary | **D** |
...
| /cottage-insurance/ | 525 | 4 / specific (good) | Yes (108w, specific/useful) | 4 | Yes | 1 | Windsor-Essex-primary | **D** |
...
| /daycare-private-school-insurance/ | 214 | 4 / specific (good) | No | 4 | Yes | 2 | Windsor-Essex-primary | **D** |
...
| /home-insurance/ | 571 | 5 / specific (good) | Yes (70w, moderate) | 6 | No — Shares 2+ FAQ pattern with auto-insurance | 1 | Windsor-Essex + Ontario | **D** |
...
| /landlord-insurance/ | 497 | 4 / specific/hedged (strong) | Yes (79w, moderate) | 4 | Yes | 1 | Windsor-Essex-primary | **D** |
...
| /motorcycle-insurance/ | 463 | 4 / specific (good) | Yes (102w, specific/useful) | 4 | Yes | 1 | Windsor-Essex + Ontario | **D** |
...
| /professional-liability-insurance/ | 391 | 4 / specific (good) | Yes (66w, moderate) | 4 | Yes | 1 | Windsor-Essex-primary | **D** |
...
| /small-business-insurance/ | 375 | 4 / specific (good) | Yes (63w, moderate) | 4 | Yes | 1 | Windsor-Essex-primary | **D** |
| /tenant-insurance/ | 519 | 4 / specific (good) | Yes (81w, moderate) | 4 | Yes | 2 | Windsor-Essex + Ontario | **D** |
| /travel-insurance/ | 532 | 4 / specific/hedged (strong) | Yes (109w, specific/useful) | 4 | Yes | 1 | Windsor-Essex-primary | **D** |
...
**45 high/medium flags** across 33 pages.  
**1 low-severity flags** (mostly surety/bond industry "guarantee" terminology) listed where present — informational, not auto-classified as D.

### /auto-insurance/
  - **[HIGH]** `coverage:Collision Coverage`: "Collision covers damage to your own vehicle from a crash with another car or object — useful when fault isn't clear or you're at fault." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[HIGH]** `coverage:Comprehensive Coverage`: "Covers theft, vandalism, weather damage, and other non-collision events." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[HIGH]** `coverage:Accident Benefits`: "Accident benefits help cover medical care, rehabilitation, caregiver costs, and income replacement for you and your passengers after an injury." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[MEDIUM]** `faq`: "All Ontario drivers are legally required to carry auto insurance." — Legal/regulatory requirement stated without verifiable Ontario basis
  - **[HIGH]** `faq`: "Collision covers damage to your vehicle from a crash with another vehicle or object, regardless of fault." — Flat coverage guarantee — states or implies automatic coverage without hedging
...
### /condo-insurance/
  - **[HIGH]** `coverage:Unit Contents & Improvements`: "Covers your belongings and upgrades you have made inside the unit — finishes, fixtures, and betterments beyond what the corporation's policy includes." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[MEDIUM]** `considerations`: "Some policies include coverage if the corporation assesses owners for the master policy deductible after a claim." — Flat inclusion statement — may overstate standard policy
...
### /cottage-insurance/
  - **[HIGH]** `coverage:Liability Protection`: "Covers injury or property damage claims arising from your ownership or use of the cottage property, including guest and recreational activity exposure." — Flat coverage guarantee — states or implies automatic coverage without hedging
...
### /daycare-private-school-insurance/
  - **[HIGH]** `coverage:General Liability`: "Covers student and visitor injury on premises — playgrounds, classrooms, and field trips." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[HIGH]** `coverage:Commercial Property`: "Covers building contents, playground equipment, and educational materials." — Flat coverage guarantee — states or implies automatic coverage without hedging
...
### /home-insurance/
  - **[MEDIUM]** `faq`: "It isn't legally required in Ontario if you own your home free and clear, but it's strongly recommended." — Legal/regulatory requirement stated without verifiable Ontario basis
...
### /landlord-insurance/
  - **[MEDIUM]** `faq`: "Eviction and rent guarantee products are separate considerations." — Guarantee language — may overstate policy terms (or surety industry term)
...
### /motorcycle-insurance/
  - **[HIGH]** `coverage:Third-Party Liability`: "Mandatory in Ontario — covers injury or damage you cause to others while operating your motorcycle on public roads." — Flat coverage guarantee — states or implies automatic coverage without hedging
...
### /professional-liability-insurance/
  - **[HIGH]** `faq`: "Contract requirements vary — $1M to $5M per occurrence is common for mid-size engagements." — Specific dollar amount — unverified limit/deductible
...
### /small-business-insurance/
  - **[HIGH]** `coverage:Commercial Property`: "Covers your equipment, inventory, and leasehold improvements against covered theft, fire, or other insured losses." — Flat coverage guarantee — states or implies automatic coverage without hedging

### /tenant-insurance/
  - **[HIGH]** `faq`: "Even without a requirement, it protects your belongings and liability — the landlord's policy does not cover your stuff." — Flat coverage guarantee — states or implies automatic coverage without hedging
  - **[HIGH]** `faq`: "Generally, a tenant policy covers the named insured and their household as defined in the policy." — Flat coverage guarantee — states or implies automatic coverage without hedging

### /travel-insurance/
  - **[HIGH]** `coverage:Baggage & Personal Effects`: "Covers loss, theft, or damage to luggage and personal belongings during your trip, within stated limits and deductibles." — Flat coverage guarantee — states or implies automatic coverage without hedging
...
| Class | Count | Routes |
|-------|------:|--------|
| A | 1 | /greenhouse-agribusiness-insurance/ |
| B | 8 | /boat-insurance/, /cyber-insurance/, /group-home-auto-insurance/, /home-sharing-insurance/, /landscaping-snow-removal-insurance/, /life-insurance/, /mobile-home-insurance/, /personal-umbrella-insurance/ |
| C | 16 | /business-interruption-insurance/, /commercial-auto-insurance/, /commercial-insurance/, /commercial-property-insurance/, /condominium-corporation-insurance/, /farm-insurance/, /fitness-gym-insurance/, /garage-dealership-insurance/, /grocery-specialty-food-insurance/, /manufacturing-insurance/, /medical-dental-insurance/, /pollution-liability-insurance/, /professional-offices-insurance/, /real-estate-insurance/, /religious-organizations-insurance/, /retail-insurance/ |
| D | 33 | /auto-insurance/, /bonding-insurance/, /builders-developers-insurance/, /builders-risk-insurance/, /cargo-freight-insurance/, /condo-insurance/, /contractors-insurance/, /convenience-store-insurance/, /cottage-insurance/, /crime-fidelity-insurance/, /daycare-private-school-insurance/, /directors-officers-insurance/, /dump-truck-insurance/, /employment-practices-liability-insurance/, /event-liability-insurance/, /food-truck-insurance/, /home-insurance/, /hotel-motel-insurance/, /landlord-insurance/, /liquor-liability-insurance/, /motorcycle-insurance/, /non-profit-insurance/, /pharmacy-insurance/, /product-recall-insurance/, /professional-liability-insurance/, /property-management-insurance/, /restaurant-insurance/, /salon-barber-insurance/, /small-business-insurance/, /tenant-insurance/, /travel-insurance/, /trucking-insurance/, /warehousing-insurance/ |
...
|-------|-------------------|---------------|
| Classification | Was flagged as thin | **D — CONTENT-SAFETY** (also thin: **214w** total) |
| Coverage cards | 4, generic "Covers…" | 4 cards, avg 20w — **flat "Covers student…" / "Covers building contents…"** |
| Practical considerations | Absent | **Still absent** |
| FAQ | 4, somewhat specific | 4 questions — product-specific but shallow overall |
| Content-safety | — | **2 high flags** on unhedged "Covers…" card copy |
...
3. **/daycare-private-school-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
4. **/employment-practices-liability-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
5. **/salon-barber-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
6. **/non-profit-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
7. **/product-recall-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
8. **/warehousing-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
9. **/crime-fidelity-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
10. **/liquor-liability-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
11. **/property-management-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
12. **/hotel-motel-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
13. **/event-liability-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
14. **/cargo-freight-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
15. **/builders-risk-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
16. **/trucking-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
17. **/restaurant-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
18. **/food-truck-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
19. **/dump-truck-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
20. **/directors-officers-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
21. **/contractors-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
22. **/small-business-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
23. **/builders-developers-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
24. **/professional-liability-insurance/** (D) — 1 content-safety flag(s): Specific dollar amount — unverified limit/deductible
25. **/bonding-insurance/** (D) — 3 content-safety flag(s): Guarantee language — may overstate policy terms (or surety industry term); Guarantee language — may overstate policy terms (or surety industry term)
26. **/auto-insurance/** (D) — 5 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
27. **/motorcycle-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
28. **/landlord-insurance/** (D) — 1 content-safety flag(s): Guarantee language — may overstate policy terms (or surety industry term)
29. **/tenant-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat coverage guarantee — states or implies automatic coverage without hedging
30. **/cottage-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
31. **/travel-insurance/** (D) — 1 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging
32. **/condo-insurance/** (D) — 2 content-safety flag(s): Flat coverage guarantee — states or implies automatic coverage without hedging; Flat inclusion statement — may overstate standard policy
33. **/home-insurance/** (D) — 1 content-safety flag(s): Legal/regulatory requirement stated without verifiable Ontario basis
34. **/religious-organizations-insurance/** (C) — Shallow depth (215w total, cards avg 20.5w, considerations absent)
35. **/fitness-gym-insurance/** (C) — Shallow depth (240w total, cards avg 23w, considerations absent)
36. **/medical-dental-insurance/** (C) — Shallow depth (242w total, cards avg 23.5w, considerations absent)
37. **/grocery-specialty-food-insurance/** (C) — Shallow depth (251w total, cards avg 26w, considerations absent)
38. **/pollution-liability-insurance/** (C) — Shallow depth (252w total, cards avg 25w, considerations absent)
39. **/condominium-corporation-insurance/** (C) — Shallow depth (277w total, cards avg 26.5w, considerations absent)
40. **/commercial-insurance/** (C) — Shallow depth (283w total, cards avg 0w, considerations absent)
41. **/garage-dealership-insurance/** (C) — Shallow depth (283w total, cards avg 27.5w, considerations absent)
42. **/real-estate-insurance/** (C) — Shallow depth (283w total, cards avg 26w, considerations absent)
43. **/retail-insurance/** (C) — Shallow depth (292w total, cards avg 28w, considerations absent)
44. **/commercial-auto-insurance/** (C) — Shallow depth (323w total, cards avg 26w, considerations absent)
45. **/professional-offices-insurance/** (C) — Shallow depth (325w total, cards avg 31w, considerations absent)
46. **/farm-insurance/** (C) — Shallow depth (332w total, cards avg 21w, considerations absent)
47. **/commercial-property-insurance/** (C) — Shallow depth (367w total, cards avg 31w, considerations absent)
48. **/business-interruption-insurance/** (C) — Shallow depth (395w total, cards avg 34w, considerations present but thin overall)
49. **/manufacturing-insurance/** (C) — Shallow depth (399w total, cards avg 29.2w, considerations absent)
50. **/landscaping-snow-removal-insurance/** (B) — Reasonable (400w) but lacks full depth — cards specific (good), considerations moderate
51. **/cyber-insurance/** (B) — Reasonable (409w) but lacks full depth — cards specific/hedged (strong), considerations moderate
52. **/personal-umbrella-insurance/** (B) — Reasonable (472w) but lacks full depth — cards specific/hedged (strong), considerations moderate
53. **/group-home-auto-insurance/** (B) — Reasonable (488w) but lacks full depth — cards specific/hedged (strong), considerations specific/useful
54. **/mobile-home-insurance/** (B) — Reasonable (506w) but lacks full depth — cards specific/hedged (strong), considerations specific/useful
55. **/life-insurance/** (B) — Reasonable (513w) but lacks full depth — cards specific/hedged (strong), considerations specific/useful
56. **/boat-insurance/** (B) — Reasonable (539w) but lacks full depth — cards specific/hedged (strong), considerations specific/useful
57. **/home-sharing-insurance/** (B) — Reasonable (588w) but lacks full depth — cards specific/hedged (strong), considerations specific/useful
