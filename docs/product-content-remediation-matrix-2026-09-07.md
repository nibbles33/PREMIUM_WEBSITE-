...
|-------|------:|------:|------------------------|----------|----------------|--------|-------------|----------------------|
| /auto-insurance/ | D | 461 | [HIGH] coverage:Collision Coverage: Collision covers damage to your own vehicle from a crash with another car or object … | high, medium | No | **D1** | Personal | Hedging pass on collision/comprehensive/accident-benefits card + FAQ wording; retain Ontario-mandatory framing where verifiable; no length expansion. |
| /bonding-insurance/ | D | 448 | [MEDIUM] coverage:Bid Bonds: Required when submitting a bid on certain contracts — guarantees you will honour your bid a… | medium | Yes | **D3** | Construction (Bonding/Surety) | Dedicated surety research pass; separate bond-type accuracy from GL; fix unhedged FAQ; do not treat as generic wording-only. |
| /builders-developers-insurance/ | D | 380 | [HIGH] faq: Builder's risk covers the structure and materials during construction or major renovation for covere… | high | Yes | **D3** | Construction | Researched expansion + hedging; builder's risk / CGL overlap needs technical review, not card rephrase alone. |
| /builders-risk-insurance/ | D | 292 | [HIGH] coverageIntro: Builder's risk covers the project itself during construction — separate from the contractor's ongo… | high | Yes | **D3** | Construction | Dedicated builders-risk research (policy period, who buys, vs CGL); replace flat 'covers structure' intro/cards with hedged, accurate framing. |
...
| /cargo-freight-insurance/ | D | 286 | [HIGH] coverageIntro: Cargo insurance addresses the goods themselves; liability covers damage to others.; [HIGH] faq: Li… | high | Yes | **D3** | Transportation | Dedicated motor-cargo research (cargo vs liability vs contingent); fix flat 'covers' intro/FAQ; thin page needs substance + hedging. |
...
| /condo-insurance/ | D | 547 | [HIGH] coverage:Unit Contents & Improvements: Covers your belongings and upgrades you have made inside the unit — finish… | high, medium | No | **D1** | Personal | Hedging pass on unit-contents card + corporation-assessment consideration; depth adequate for personal condo — no length chase. |
...
| /contractors-insurance/ | D | 345 | [HIGH] faq: Builder's risk covers the structure and materials during construction or renovation for covered peri… | high | Yes | **D3** | Construction | Dedicated construction research despite explorer visuals; fix builder's-risk FAQ flat claim; add considerations for subs/tools/wrap-up. |
| /convenience-store-insurance/ | D | 214 | [HIGH] coverage:Commercial Property: Covers building, coolers, shelving, and inventory including tobacco and lottery pro… | high | Yes | **D2** | Hospitality/Food | Hospitality-family research batch + hedging; thin (214w) with flat property card; add considerations ( tobacco/lottery, hours). |
| /cottage-insurance/ | D | 525 | [HIGH] coverage:Liability Protection: Covers injury or property damage claims arising from your ownership or use of the … | high | No | **D1** | Personal | Single liability-card hedging fix; seasonal/vacant considerations already present — accuracy over expansion. |
| /crime-fidelity-insurance/ | D | 253 | [HIGH] coverage:Employee Dishonesty: Covers theft of money, securities, or property by employees acting fraudulently. | high | Yes | **D3** | Industrial/Coverage-Types | Specialized crime/fidelity research; flat employee-dishonesty card; thin page needs researched expansion, not wording-only. |
| /daycare-private-school-insurance/ | D | 214 | [HIGH] coverage:General Liability: Covers student and visitor injury on premises — playgrounds, classrooms, and field tr… | high | Yes | **D2** | Professional/Institutional | Audit snapshot: thin + 2 high flags. NOTE: owner-approved rewrite exists on cursor/daycare-content-2026-09-07 — verify before re-work. *(Note: Audit predates approved daycare implementation branch.)* |
| /directors-officers-insurance/ | D | 331 | [HIGH] faq: GL covers the organization's operational liability, not personal claims against directors for manage… | high | Yes | **D3** | Professional/Institutional | Dedicated D&O research; fix GL-vs-D&O FAQ flat claim; extend considerations for side-A/B/C if accurate. |
| /dump-truck-insurance/ | D | 326 | [HIGH] faq: Liability covers damage to others; cargo addresses the material you're hauling. | high | Yes | **D3** | Transportation | Dedicated heavy-commercial auto/cargo research; fix liability/cargo FAQ flat split; add hauling/disclosure considerations. |
| /employment-practices-liability-insurance/ | D | 227 | [HIGH] coverage:Wrongful Termination: Covers claims alleging improper dismissal or constructive dismissal. | high | Yes | **D3** | Professional/Institutional | Dedicated EPL research (Ontario employment context); thin + flat wrongful-termination card; needs researched expansion. |
| /event-liability-insurance/ | D | 266 | [HIGH] coverage:Third-Party Bodily Injury: Covers claims when attendees are injured during the event — trips, falls, and… | high | Yes | **D2** | Hospitality/Food (adjacent — events) | Event-specific research within hospitality batch where possible; hedging on injury card; add venue/permit considerations. *(Note: Best-fit: Hospitality/Food batch for shared event/permit patterns; distinct from restaurant property.)* |
...
| /food-truck-insurance/ | D | 307 | [HIGH] coverage:Commercial Auto: Covers the truck or trailer as a commercial vehicle — liability and physical damage whi… | high | Yes | **D2** | Hospitality/Food | Hospitality batch research; fix commercial-auto flat card; add commissary/liquor/permit considerations. |
...
| /home-insurance/ | D | 571 | [MEDIUM] faq: It isn't legally required in Ontario if you own your home free and clear, but it's strongly recommen… | medium | No | **D1** | Personal | Single medium FAQ hedging fix (legal requirement framing); otherwise adequate depth — no expansion for length. |
| /hotel-motel-insurance/ | D | 263 | [HIGH] coverage:Commercial Property: Covers the building, furnishings, linens, and equipment against covered fire, water… | high | Yes | **D2** | Hospitality/Food | Hospitality batch; fix property flat card; add pool/guest-belongings/BI considerations. |
| /landlord-insurance/ | D | 497 | [MEDIUM] faq: Eviction and rent guarantee products are separate considerations. | medium | No | **D1** | Personal | FAQ hedging on eviction/guarantee products; core landlord depth adequate — specificity over length. |
| /liquor-liability-insurance/ | D | 258 | [HIGH] coverage:Patron Injury & Property Damage: Covers claims that an intoxicated patron injured someone or damaged pro… | high | Yes | **D2** | Hospitality/Food | Dedicated liquor-liability research within hospitality batch; fix patron-injury flat card; regulatory context if verified. |
...
| /motorcycle-insurance/ | D | 463 | [HIGH] coverage:Third-Party Liability: Mandatory in Ontario — covers injury or damage you cause to others while operatin… | high | No | **D1** | Personal | Hedge mandatory-liability card (Ontario context is verifiable — keep factual, remove flat 'covers'); no length expansion. |
| /non-profit-insurance/ | D | 244 | [HIGH] coverage:General Liability: Covers injury and property damage claims at events, offices, and program locations. | high | Yes | **D2** | Professional/Institutional | Institutional batch; fix GL flat card; add board/volunteer/D&O cross-reference considerations. |
| /pharmacy-insurance/ | D | 205 | [HIGH] coverage:Commercial Property: Covers inventory, fixtures, and dispensing equipment including narcotics storage se… | high | Yes | **D2** | Retail/Services | Regulated retail research; thinnest D page (205w); fix property flat card; narcotics/compounding disclosures. |
...
| /product-recall-insurance/ | D | 252 | [HIGH] faq: Product liability covers injury or damage claims from defective products.; [HIGH] faq: Recall covers the cos… | high | Yes | **D3** | Industrial/Coverage-Types | Dedicated recall vs product-liability research; fix two flat FAQ claims; thin page. |
| /professional-liability-insurance/ | D | 391 | [HIGH] faq: Contract requirements vary — $1M to $5M per occurrence is common for mid-size engagements. | high | Yes | **D3** | Professional/Institutional | Dedicated E&O research; remove/unverify $1M–$5M FAQ claim; hedging pass on profession-specific scope. |
...
| /property-management-insurance/ | D | 261 | [HIGH] coverage:General Liability: Covers injury and property damage claims arising from managed properties and manageme… | high | Yes | **D2** | Industrial/Coverage-Types | Property-mgmt research; fix GL flat card; add tenant/legal-expense/pool considerations. |
...
| /restaurant-insurance/ | D | 306 | [HIGH] coverage:Property Coverage: Covers your building improvements, furniture, and kitchen equipment against covered l… | high | Yes | **D2** | Hospitality/Food | Hospitality batch priority; fix property flat card despite hedged family label; add spoilage/liquor/delivery considerations. |
...
| /salon-barber-insurance/ | D | 239 | [HIGH] coverage:Product Liability: Covers claims that retail products sold in-salon caused allergic reaction or injury. | high | Yes | **D2** | Retail/Services | Retail/services batch; fix product-liability flat card; add professional/beauty-service considerations. |
| /small-business-insurance/ | D | 375 | [HIGH] coverage:Commercial Property: Covers your equipment, inventory, and leasehold improvements against covered theft,… | high | No | **D1** | Industrial/Coverage-Types | Single commercial-property card hedging; considerations exist — wording-only pass, not Greenhouse-length expansion. |
| /tenant-insurance/ | D | 519 | [HIGH] faq: Even without a requirement, it protects your belongings and liability — the landlord's policy does n…; [HIGH… | high | No | **D1** | Personal | FAQ hedging pass ('protects your belongings', household coverage scope); adequate for simpler personal line — resist length expansion. *(Note: Explicit: quality bar met with accuracy/specificity at lower word count than Greenhouse/Daycare.)* |
| /travel-insurance/ | D | 532 | [HIGH] coverage:Baggage & Personal Effects: Covers loss, theft, or damage to luggage and personal belongings during your… | high | No | **D1** | Personal | Single baggage/personal-effects card hedging; strong considerations already — wording fix only. |
| /trucking-insurance/ | D | 293 | [HIGH] faq: Liability covers injury and damage to others; cargo is about the freight itself. | high | Yes | **D3** | Transportation | Dedicated trucking research (MCS-90, cargo, bobtail, jurisdiction); fix liability/cargo FAQ; never wording-only. |
| /warehousing-insurance/ | D | 252 | [HIGH] coverage:Commercial Property: Covers the warehouse structure, racking, forklifts, and handling equipment against … | high | Yes | **D2** | Industrial/Coverage-Types | Warehouse/bailee research; fix property flat card; add bailee/legal-liability considerations. |
...
- **Personal:** D1×8
- **Professional/Institutional:** D2×2, D3×3, C1×1, C2×1
...
- **[HIGH]** `coverage:General Liability`: "Covers student and visitor injury on premises — playgrounds, classrooms, and field trips."
- **[HIGH]** `coverage:Commercial Property`: "Covers building contents, playground equipment, and educational materials."
...
#### /tenant-insurance/
- **[HIGH]** `faq`: "Even without a requirement, it protects your belongings and liability — the landlord's policy does not cover your stuff."
